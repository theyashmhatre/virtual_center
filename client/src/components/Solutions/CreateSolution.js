...
const CreateSolution = () => {
  ...
  return (
    <div className="w-full border-2 py-10 px-32 lg:px-24 md:px-10 sm:px-5 xs:px-2">
      <div>
        <h1 className="text-3xl sm:text-2xl text-center font-bold my-5">
          Create Solution
        </h1>
        <div className="space-y-5">
          ...
          <div className="text-center pt-6">
            <button
              className="py-3 px-14 sm:px-8 rounded-full bg-black-btn text-white font-bold"
              onClick={onSubmit}
            >
              Submit
            </button>
